...
![The 2024 Heat Response Plan for Summer](qimages/2024HeatResponsePlan.png){fig-align="center"}
...
![Derived land surface temperatures for the city of Phoenix using Landsat TM and selected census blocks in samples A and B. The points represent the selected census blocks.](qimages/4.3.jpg){fig-align="center"}
