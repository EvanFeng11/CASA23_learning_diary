...
![Original image. (a) panoramic image; (b) the flat areas of image; (c) mountain image at band 1. The figures were visualized under ENVI 4.2 software in default image enhancement and true-color composite (R:3, G:2, B:1), where (a) is the zoom out panoramic view by multiplier factor 0.03; (b) and (c) are part of (a) at the full-scale display. The same below.](qimages/3origin.png) ![The reflectance image based on ACVSS (eq. (14)). (a) panoramic image; (b) the flat areas of image; (c) mountain image at band 1.](qimages/3ACVSS.png)
...
![SRS data fusion could support global biodiversity monitoring efforts through SRS-EBVs requires collaboration between remote sensing scientists and biodiversity/ecology scientists](qimages/3ecology.jpg)
